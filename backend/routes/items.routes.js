...
router.use(csrf.cookieParser());

//FUNCTION TO GET THE NEW GENERATED CSRF TOKEN CALLED BY CLIENT
router.get('/getCsrfToken', csrf.csrfProtect, function (req, res) {
  console.log('Token generated by server: ' + req.csrfToken());
...
router.post("/createItem", csrf.parseForm, csrf.csrfProtect,
  auth,
  [
  ...
  try{
    ...
    console.log('Token from Client: ' + req.body._csrf) //TRYING TO SEE IF THE CSRF TOKEN IS THE SAME
    const item = req.body;
